# 🚀 90 Days of DevOps + AI

![Progress](https://img.shields.io/badge/Day-15%20of%2090-blue?style=flat-square)
![Status](https://img.shields.io/badge/Status-In%20Progress-green?style=flat-square)
![AWS](https://img.shields.io/badge/AWS-Experienced-orange?style=flat-square&logo=amazonaws)
![Linux](https://img.shields.io/badge/Linux-Daily%20Driver-yellow?style=flat-square&logo=linux)
![Docker](https://img.shields.io/badge/Docker-Week%202%20Complete-blue?style=flat-square&logo=docker)
![Kubernetes](https://img.shields.io/badge/Kubernetes-Coming%20Soon-326CE5?style=flat-square&logo=kubernetes)
![Terraform](https://img.shields.io/badge/Terraform-Coming%20Soon-7B42BC?style=flat-square&logo=terraform)
![AI](https://img.shields.io/badge/AI%20Tools-Integrating-ff69b4?style=flat-square)
...
### 🔴 Phase 3: Advanced & Portfolio (Days 61–90)
...
| Day | Date | Topic | Key Deliverable | LinkedIn |
|-----|------|-------|----------------|---------|
| 001 | 2026-04-25 | DevOps + AI fundamentals | glossary.md, skills-audit.md | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 002 | 2026-04-26 | Linux basics — commands, permissions | system-info.sh (AI-assisted) | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 003 | 2026-04-27 | Linux processes, services, networking | server-health.sh (no AI) | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 004 | 2026-04-28 | Bash scripting, cron jobs | smart-monitor.sh, cron setup | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 005 | 2026-04-29 | Git — branches, PRs, merge, stash, tags | First PR created and merged | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 006 | 2026-04-30 | GitHub Issues, branch protection, Actions | learn-devops.yml — first CI pipeline | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 007 | 2026-05-01 | Git advanced — stash, tags, mini project | devops-toolkit.sh, tagged v0.1.0 | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 008 | 2026-05-12 | Docker fundamentals | Container DNS, networking, resource limits | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 009 | 2026-05-13 | Dockerfiles — build your own images | nginx image + Python API pushed to Docker Hub | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 010 | 2026-05-14 | Docker Volumes + Docker Compose | 3-service stack — data persists container restarts | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
| 011 | 2026-05-15 | Docker CI/CD pipeline | Auto build + push to Docker Hub on every merge | [Post](https://www.linkedin.com/in/valajaharshatheja/) |
...
📁 [Week-1-project/devops-toolkit.sh](./Week-1-project/devops-toolkit.sh) · Tagged: `v0.1.0`

---

### Week 2 Project — DevOps Dashboard API
...
📁 [Week-2-Project/](./Week-2-Project/) · Docker image: `awspractical57/devops-api:v1`
...
| Image | Description |
|-------|-------------|
| [`awspractical57/devops-journey:v1`](https://hub.docker.com/u/awspractical57) | Custom nginx page — DevOps journey homepage |
| [`awspractical57/devops-api:v1`](https://hub.docker.com/u/awspractical57) | Python DevOps Dashboard API |
...
|----------|---------|------|
| `learn-devops.yml` | Every push / PR | System checks + ShellCheck validation |
| `shellcheck.yml` | Every push / PR | Validates all `.sh` scripts automatically |
| `docker-cicd.yml` | PR + merge to main | build-and-test → security-scan → push-to-dockerhub |
